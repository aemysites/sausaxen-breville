...
## Environments
- Preview: https://main--sausaxen-breville--aemysites.aem.page/
- Live: https://main--sausaxen-breville--aemysites.aem.live/
- Block Library: https://main--sausaxen-breville--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `sausaxen-breville` directory in your favorite IDE and start coding :)
